...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?\DateTimeInterface $lastVoteDate = null;
    ...
    public function getLastVoteDate(): ?\DateTimeInterface
    {
        return $this->lastVoteDate;
    }

    public function setLastVoteDate(?\DateTimeInterface $lastVoteDate): static
    {
